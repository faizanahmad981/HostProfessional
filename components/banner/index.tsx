    ...
    <div className="grid grid-cols-1  gap-4  my-10   md:grid-cols-2 lg:gridcols-2">
      <div className="">
        ...
        <div className="flex flex-row  leading-9">
          ...
          <span className="mx-1">
            {" "}
            Keine <span className="font-bold">
              {" "}
              teuren Anschaffungskosten
            </span>{" "}
          </span>
        </div>
        <div className="flex flex-row  leading-9">
        ...
        <div className="rounded-lg bg-[#FEFDFB] w-[333px] border border-[#FAC800] md:w-[500px] px-2 py-2 my-6">
          <p>
            &ldquo;Unsere ISDN-Leitung wurde mit nur 6 Wochen Frist gekündigt.
            <br />
            Hostprofis hat unser neues System in nur 14 Tagen eingerichtet und
            <br />
            wir konnten alle Nummern behalten. Keine Ausfallzeit, kein
            Stress.&rdquo;
            <br />
          </p>
